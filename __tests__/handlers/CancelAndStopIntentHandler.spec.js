...
describe('Sequence 05. Test scenario: AMAZON.CancelIntent and AMAZON.StopIntent', () => {
  ...
  it('should be able can return response when AMAZON.CancelIntent', async () => {
    ...
    const outputSpeech = testResponseBuilder
      .speak(speaks.VOICE_START + speaks.BYE_BYE[0] + speaks.VOICE_END)
      .withStandardCard(speaks.SKILL_NAME, speaks.BYE_BYE[0])
  ...
  it('should be able can return response when AMAZON.StopIntent', async () => {
    ...
    const outputSpeech = testResponseBuilder
      .speak(speaks.VOICE_START + speaks.BYE_BYE[1] + speaks.VOICE_END)
      .withStandardCard(speaks.SKILL_NAME, speaks.BYE_BYE[1])
      .withShouldEndSession(true)
      .getResponse();
